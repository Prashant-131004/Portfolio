      ...
      skills: [
        {
          ...
          icon: (
            <img
              src={JavaScriptLogo}
              alt="JavaScript"
              className="w-7 h-7 object-contain rounded-full bg-white border"
            />
          ),
        },
        {
      ...
      skills: [
        {
          ...
          level: 75,
          icon: (
            <SmartphoneIcon className="w-7 h-7 rounded-full bg-white border p-1" />
          ),
        },
        {
          name: "Node.js",
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#333333]/80 max-w-2xl mx-auto">
              A comprehensive overview of my technical skills and what I'm
              currently learning.
            </p>
          </div>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {skillCategories.map((category, index) => (
            <AnimatedSection key={index} delay={index * 0.2}>
              <div
                className={`glass p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#e5e7eb] bg-white/80 backdrop-blur-md transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:border-[#a5b4fc] ${category.color} h-full`}
              >
                    ...
                    <div key={skillIndex}>
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <div className="p-1.5 rounded-full bg-white/80 text-[#333333]">
                            {skill.icon}
                          </div>
                        ...
                        <span className="text-[#333333]/60 text-sm">
                          {skill.level}%
                        </span>
                      </div>
